defmodule WeaviateApi.Backups.RestoreStatus do
  @moduledoc """
  Functions for getting the status of a restore operation in Weaviate.
  """
  ...
  ## Examples
      ...
      {:ok, response} = WeaviateApi.Backups.RestoreStatus.get_status("s3", "my-backup")
  """
